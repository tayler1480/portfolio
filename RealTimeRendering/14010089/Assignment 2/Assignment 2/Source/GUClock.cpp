...
GUClock::GUClock(const string& clockName, const gu_seconds startDelay) {
...
gu_seconds GUClock::ConvertTimeIntervalToSeconds(gu_time_interval t) {
...
GUClock* GUClock::CreateClock(const string& clockName, const gu_seconds startDelay) {
	...
	return new GUClock(clockName, startDelay);
}
...
void GUClock::tick() {
	...
	if (frameCounter)
		frameCounter->updateFrameCounterForElaspsedTime(GUClock::ConvertTimeIntervalToSeconds((currentTimeIndex - baseTime) - totalStopTime));
}
...
gu_seconds GUClock::actualTimeElapsed() const {
	...
	return GUClock::ConvertTimeIntervalToSeconds(GUClock::ActualTime() - baseTime);
}


gu_seconds GUClock::gameTimeElapsed() const {

	return GUClock::ConvertTimeIntervalToSeconds((((clockStopped()) ? stopTimeIndex : GUClock::ActualTime()) - baseTime) - totalStopTime);
}


gu_seconds GUClock::gameTimeDelta() const {

	return GUClock::ConvertTimeIntervalToSeconds(deltaTime);
}
